...
from para_conc.core.amb_tank import AMB_TANK, AMB_LIST
        ...
        for (w,t), f in raw_token_tag_freq.items():
            ...
            if t in ["XM", "XN", "XW"]:  
                ...
                try:                       
                    ...
                    if file_id:
                        msg = f"WARNING: critical en words error found in {file_id} => {w}/{t}/{f}\n"
                    else:
